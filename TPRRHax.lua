...
Sound:CreateButton("Play Sound", function()
    ...
    print("Matr1x Hub | Sound Playing | SoundId: " .. getgenv().Config.SoundId, "Volume: " .. getgenv().Config.Volume, "Pitch: " .. getgenv().Config.Pitch, "Type: " .. getgenv().Config.Type)
end)

Sound:CreateButton("Stop Sound", function()
    ReplicatedStorage.Events.AnimatronicSoundLoopStop:FireServer("AlexR32 Was Here")
    print("Matr1x Hub | Sound Stopped")
end)
...
ScriptCreator:CreateTextLabel("Matr1x#5430 @ discord.com")
...
--loadstring(game:HttpGet("https://raw.githubusercontent.com/NBDMatr1x/Roblox/main/TPRRHax.lua"))()
